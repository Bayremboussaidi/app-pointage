        ...
        for (Cell cell : headerRow) {
            ...
            switch (header.toLowerCase().replaceAll("[^a-zA-Z0-9]", "")) {
                ...
                case "date":
                    ...
                    break;
                case "id":
                    columnIndex.put("id", cell.getColumnIndex());
                    break;
                case "prenom":
                case "nomprenom":
